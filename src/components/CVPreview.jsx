...
export const CVPreview = () => {
  const { personal, summary, experience, education, skills, languages } = useCVStore();

  return (
    <div id="cv-preview" className="w-full lg:w-[816px] bg-white shadow-lg border border-gray-200 p-6 lg:p-12">
      {/* Header */}
      <div className="mb-6">
